...
# First Image
                ...
                img2_top=img2_top.resize((650,700),Image.ANTIALIAS)
...
# Second Image
                img3_down=Image.open("C:\\Users\\rakes\\OneDrive\\Documents\\Face recognition of students in python\\rak5.jfif")
                img3_down=img3_down.resize((950,700),Image.ANTIALIAS)
...
# ****************************************************** Attendence *********************************************
        ...
        def face_recog(self):
                ...
                def recogize(img,clf,facecascad):
                        cord=draw_boundary(img,facecascad,1.1,10,(255,255,255),"Face",clf)
                        return img
                ...
                while True:
                        ...
                        img=recogize(img,clf,face_cascad)
